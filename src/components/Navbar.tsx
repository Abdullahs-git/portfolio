          ...
          >
            ...
            <div className="pt-4 flex items-center justify-between border-t border-gray-100 font-mono text-[10px] tracking-wider uppercase text-gray-500">
              <a
                ...
                target="_blank"
                rel="noreferrer"
                className="flex items-center gap-1.5 text-black border border-black px-4 py-2 font-semibold hover:bg-black hover:text-white transition-colors"
              >
                <Download className="w-3.5 h-3.5" />
                <span>DOWNLOAD CV</span>
              </a>
              <span className="text-black font-semibold">AVAILABLE / REMOTE</span>
            </div>
          </motion.div>
        )}
      </AnimatePresence>
